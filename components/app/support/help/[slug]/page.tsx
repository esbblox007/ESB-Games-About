      ...
      <main className="support-help-page">
        <div className="support-help-container">
          ...
          <aside className="support-help-cta">
            <div><strong>Still need help?</strong><p>Open a secure support conversation and provide the details needed for the appropriate ESB Games team to review your request.</p></div>

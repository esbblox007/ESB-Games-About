...
export default function SearchDialog({ open, onClose }: SearchDialogProps) {
  ...
  return (
    <div className="modal-backdrop search-backdrop" role="presentation" onMouseDown={onClose}>
      <section ref={dialogRef} className="search-modal search-modal-expanded" role="dialog" aria-modal="true" aria-labelledby="search-dialog-title" onMouseDown={(event: ReactMouseEvent<HTMLElement>) => event.stopPropagation()}>

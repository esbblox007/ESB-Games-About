...
const STATIC_CONTENT_LAST_REVIEWED = new Date("2026-08-23T18:10:00Z");
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [...staticEntries, ...policyEntries, ...articleEntries, ...starterDocumentationEntries, ...documentationEntries, ...supportEntries, ...careerEntries];
}

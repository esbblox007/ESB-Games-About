      ...
      <div className="policy-page">
        <header className="policy-hero">
          <div className="policy-container">
            ...
            <h1>{item.title}</h1>
            {item.draft && <div className="policy-draft-notice"><strong>Pre-launch document</strong><span>This source document is still marked as a draft. Missing legal dates, entity details and other bracketed fields have not been invented.</span></div>}
          </div>
        </header>

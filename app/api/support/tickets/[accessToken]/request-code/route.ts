  ...
  try {
    ...
    const delivery = await sendEmail({
      ...
      text: [
        "ESB Games Support",
        "",
        `You requested secure access to support ticket ${ticket.ticket_reference}.`,
        ...
        "If you did not request access to this ticket, contact support@esbgames.com.",
      ].join("\n"),
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:620px;border:1px solid #263252;border-radius:20px;overflow:hidden;background:#0a1020">
        ...
        <tr><td style="padding:38px 30px">
          <h1 style="margin:0 0 14px;font-size:30px;line-height:1.15;color:#ffffff">Verify your support ticket access.</h1>
          ...
          <p style="margin:0;color:#8798b9;font-size:13px;line-height:1.6">Never share the private link or verification code with anyone, including ESB Games staff. If you did not request access to this ticket, contact support@esbgames.com.</p>
        </td></tr>

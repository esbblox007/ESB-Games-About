  ...
  return (
    <PageShell>
      <div className="parental-page">
        <section className="parental-hero"><div className="parental-container parental-hero-grid"><div className="parental-hero-copy"><Link href="/help" className="help-back-link"><ArrowIcon size={15} /> Back to Help</Link><span className="parental-eyebrow"><ShieldIcon size={15} /> Family Centre · In development</span><h1>Family controls for<br /><span className="gradient-text">linked accounts.</span></h1><p>Family Centre is the product area for parental controls and linked-account management. Trust &amp; Safety explains the wider safety framework, while Support handles private family cases that need authorised staff.</p><div className="parental-actions"><a href="https://family.esbgames.com" className="button button-primary"><ShieldIcon size={17} /> Visit Family Centre</a><a href="#linking-steps" className="button button-secondary">View planned linking <ArrowIcon size={16} /></a></div><div className="parental-trust-row"><span><ShieldIcon size={17} /> Privacy-focused design</span><span><CheckIcon size={17} /> Age-aware design direction</span><span><UsersIcon size={17} /> Parent-managed settings planned</span><span><UsersIcon size={17} /> Built for families</span></div></div><div className="parental-product-wrap"><span className="product-status-label">Concept preview · In development</span><FamilyDashboardMockup /></div></div></section>
        ...
        <section className="parental-band-section"><div className="parental-container parental-band-grid"><article><span className="eyebrow">Product direction</span><h3>One place for approvals, reports and family settings.</h3><p>The planned dashboard brings linked family members, recent activity and adjustable limits into one place. Individual capabilities will be labelled when they become available.</p></article><article><span className="eyebrow">Need guidance or a case review?</span><h3>Use the right route.</h3><p>Help Centre covers common family tasks. Trust &amp; Safety explains safety rules and systems. Support is the private route for an account-specific issue that needs authorised staff.</p></article></div></section>

        <section className="parental-safety-band"><div className="parental-container"><div className="parental-safety-card"><span className="parental-safety-icon"><ShieldIcon size={31} /></span><div><h2>Family safety is broader than parental controls.</h2><p>Family Centre manages linked-account controls; Trust &amp; Safety explains prevention, reporting and enforcement across the wider ESB Games ecosystem.</p></div><Link href="/help/trust-safety" className="button button-secondary">Open Trust &amp; Safety <ArrowIcon size={16} /></Link></div></div></section>
      </div>
    </PageShell>
  );
}

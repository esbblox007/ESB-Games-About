...
export const metadata: Metadata = {
  title: "Family Centre",
  description: "Explore linked-account and parental-control features being developed for ESB Games. Family and safety guidance lives in Help Centre and private cases belong in Support.",
  ...
  return (
    <PageShell>
      <div className="parental-page">
        <section className="parental-hero"><div className="parental-container parental-hero-grid"><div className="parental-hero-copy"><span className="parental-eyebrow"><ShieldIcon size={15} /> Family Centre · In development</span><h1>Family controls for<br /><span className="gradient-text">linked accounts.</span></h1><p>Family Centre is the product area for parental controls and linked-account management. Help Centre contains family and safety guidance, while Support handles private family cases that need authorised staff.</p><div className="parental-actions"><a href="https://family.esbgames.com" className="button button-primary"><ShieldIcon size={17} /> Visit Family Centre</a><a href="#linking-steps" className="button button-secondary">View planned linking <ArrowIcon size={16} /></a></div><div className="parental-trust-row"><span><ShieldIcon size={17} /> Privacy-focused design</span><span><CheckIcon size={17} /> Age-aware design direction</span><span><UsersIcon size={17} /> Parent-managed settings planned</span><span><GlobeIcon size={17} /> Linked-account direction</span></div></div><div className="parental-product-wrap"><span className="product-status-label">Concept preview · In development</span><FamilyDashboardMockup /></div></div></section>

        <div className="parental-container service-pathways-wrap"><ServicePathways current="family" title="Family Centre, Help and Support have clear jobs" /></div>
        ...
        <section className="parental-band-section"><div className="parental-container parental-band-grid"><article><span className="eyebrow">Product direction</span><h3>One place for approvals, reports and family settings.</h3><p>The planned dashboard brings linked family members, recent activity and adjustable limits into one place. Individual capabilities will be labelled when they become available.</p></article><article><span className="eyebrow">Need guidance or a case review?</span><h3>Use the right route.</h3><p>Help Centre covers common family tasks, safety guidance and policies. Support is the private route for an account-specific issue that needs authorised staff.</p></article></div></section>

        <section className="parental-safety-band"><div className="parental-container"><div className="parental-safety-card"><span className="parental-safety-icon"><ShieldIcon size={31} /></span><div><h2>Family safety is broader than parental controls.</h2><p>Family Centre manages linked-account controls; Help Centre explains safety guidance, reporting and the wider Trust &amp; Safety framework.</p></div><Link href="/help/trust-safety" className="button button-secondary">Open safety guidance <ArrowIcon size={16} /></Link></div></div></section>
      </div>
    </PageShell>
  );
}

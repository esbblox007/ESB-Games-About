  ...
  return (
    <PageShell>
      <div className="parental-page">
        ...
        <section className="parental-band-section"><div className="parental-container parental-band-grid"><article><span className="eyebrow">Product direction</span><h3>One place for approvals, reports and family settings.</h3><p>The planned dashboard brings linked family members, recent activity and adjustable limits into one place. Individual capabilities will be labelled when they become available.</p></article><article><span className="eyebrow">Need more help?</span><h3>We&apos;re here to support families.</h3><p>Support guidance for linking accounts and understanding family settings will be published as the controls become available.</p></article></div></section>

        <section className="parental-safety-band"><div className="parental-container"><div className="parental-safety-card"><span className="parental-safety-icon"><ShieldIcon size={31} /></span><div><h2>Family safety is a core design priority.</h2><p>ESB Games is being designed to support creativity and connection with age-aware safety, privacy and family controls. Legal and compliance requirements will be reviewed as features move toward release.</p></div><Link href="/trust/safety" className="button button-secondary">Learn More About Safety <ArrowIcon size={16} /></Link></div></div></section>
      </div>
    </PageShell>
  );
}

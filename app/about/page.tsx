    ...
    <PageShell>
      <div className="about-page-v2">
        ...
        <section className="about-principles-section">
          <div className="about-section-inner">
            <Reveal className="about-section-heading"><span className="about-kicker">What guides us</span><h2>The principles we play by.</h2><p>Every feature, policy and product decision should make ESB Games safer, fairer and more useful for the people who use it.</p></Reveal>

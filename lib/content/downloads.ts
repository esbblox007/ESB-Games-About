...
const productDefinitions: Omit<DownloadProduct, "releases">[] = [
  {
    id: "play-platform",
    slug: "play-platform",
    name: "ESB Games Player",
    description: "The official ESB Games player application, being developed for discovering and playing experiences across the platform.",
    icon: "play",
    learnMoreHref: "/",
  },
  {
    ...
    slug: "studio",
    name: "ESB Studio",
    description: "The official ESB Games creation environment for building and testing experiences, currently in development.",
    icon: "studio",

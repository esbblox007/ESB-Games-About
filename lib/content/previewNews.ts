...
export const previewNewsArticles: NewsArticle[] = [
  {
    ...
    body: [
      { type: "callout", tone: "info", title: "Preview content", text: "This editorial preview is only shown when preview mode is enabled. Public articles are published separately." },
      ...
      { type: "paragraph", text: "A universal ESB Games account is planned to connect the ESB Games platform, Creator Hub, ESB Studio, Family Centre and relevant support services." },
      { type: "list", items: ["Discover and play community experiences", "Create and publish through ESB Studio", "Belong through friends, groups and events", "Use family and safety tools across supported services"] },
      ...
      { type: "quote", text: "Discovering, belonging and building should feel like parts of one connected universe, not separate products.", attribution: "ESB Games product direction" },
